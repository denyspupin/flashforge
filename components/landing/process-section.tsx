            ...
            {STEPS.map((step, i) => {
              ...
              return (
                <Reveal key={step.n} delay={0.1 + i * 0.08}>
                  <article className="group relative overflow-hidden rounded-2xl border border-ink/10 bg-paper/60 p-8 transition-all hover:border-ink/20 hover:bg-paper sm:p-10">
                    <div className="ember-glow pointer-events-none absolute -right-20 -top-20 h-48 w-48 rounded-full opacity-0 transition-opacity duration-700 group-hover:opacity-100" />
                    ...
                    <div className="relative flex flex-col gap-6 sm:flex-row sm:items-start sm:gap-8">
                      <div className="flex shrink-0 items-center gap-4 sm:flex-col sm:items-start sm:gap-2">
                        <span
                          className="font-display-soft text-5xl text-ember/80"
